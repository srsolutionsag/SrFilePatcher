...
namespace srag\ActiveRecordConfig\SrFilePatcher;

use ilPluginConfigGUI;
use ilUtil;
use srag\ActiveRecordConfig\SrFilePatcher\Exception\ActiveRecordConfigException;
use srag\DIC\SrFilePatcher\DICTrait;

/**
 * Class ActiveRecordConfigGUI
 *
 * @package srag\ActiveRecordConfig\SrFilePatcher
 *

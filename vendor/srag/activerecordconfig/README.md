...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrFilePatcher\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrFilePatcher\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrFilePatcher\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```

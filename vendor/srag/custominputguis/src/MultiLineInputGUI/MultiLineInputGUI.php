...
namespace srag\CustomInputGUIs\SrFilePatcher\MultiLineInputGUI;
...
use ilToolbarItem;
use ilUtil;
use srag\CustomInputGUIs\SrFilePatcher\GlyphGUI\GlyphGUI;
use srag\DIC\SrFilePatcher\DICTrait;

/**
 * Class MultiLineInputGUI
 *
 * @package srag\CustomInputGUIs\SrFilePatcher\MultiLineInputGUI
 *
